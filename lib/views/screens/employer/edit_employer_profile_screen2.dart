...
/// Employer Profile Edit Screen
/// Lime green theme (#D2FF1F) for employer
class EditEmployerProfileScreen2 extends StatefulWidget {
  const EditEmployerProfileScreen2({super.key});

  @override
  State<EditEmployerProfileScreen2> createState() => _EditEmployerProfileScreen2State();
}

class _EditEmployerProfileScreen2State extends State<EditEmployerProfileScreen2> {
      ...
      builder: (context) {
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ListTile(
                leading: const Icon(Icons.visibility, color: AppColors.electricLime),
                title: Text(
                  'Preview Profile',
              ...
              ListTile(
                leading: const Icon(Icons.verified_user, color: AppColors.electricLime),
                title: Text(
              ...
              ListTile(
                leading: const Icon(Icons.delete_outline, color: AppColors.red1),
                title: Text(
                  'Delete Account',
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          ...
          style: GoogleFonts.aclonica(color: AppColors.grey6, fontSize: 14),
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: Text(
              'Cancel',
              style: GoogleFonts.aclonica(color: AppColors.electricLime),
            ),
          ),
          TextButton(
            onPressed: () {
